...
public class CustomAdapterDisease extends RecyclerView.Adapter<CustomAdapterDisease.MyViewHolder> {
    ...
    ArrayList<String> subDiseases;

    Context context;

    public CustomAdapterDisease(Context context, ArrayList<String> diseaseNames, ArrayList<String> treatments, ArrayList<String> medications, ArrayList<String> plannedSurgeries, ArrayList<String> subDiseases) {
